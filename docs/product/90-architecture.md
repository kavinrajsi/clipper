...
| **Stale legal copy** — states payouts are "not yet implemented" | `src/app/(legal)/clipper-terms/page.js:67` | Rewrite to match the working Razorpay Route flow. This one is a real liability, not a typo |
